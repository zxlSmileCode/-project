        ...
        <main className="main">
        ...
        </main>
          {
            <footer className="footer">
              <ul>
                <li onClick={this.goto.bind(this, 'home')} className={(this.props.currentTab === 'home') ? "selected" : null}>
                  <i className="iconfont icon-shouye" style={{ fontSize: "25px" }} />
                  <span>首页</span>
                </li>
                <li onClick={this.goto.bind(this, 'yigou')} className={(this.props.currentTab === 'yigou') ? "selected" : null}>
                  <i className="iconfont icon-shoutibao" style={{ fontSize: "25px" }} />
                  <span>艺购</span>
                </li>
                <li onClick={this.goto.bind(this, 'yicang')} className={(this.props.currentTab === 'yicang') ? "selected" : null}>
                  <i className="iconfont icon-icon-" style={{ fontSize: "25px" }} />
                  <span>艺藏</span>
                </li>
                <li onClick={this.goto.bind(this, 'yiyan')} className={(this.props.currentTab === 'yiyan') ? "selected" : null}>
                  <i className="iconfont icon-faxian-yanjing" style={{ fontSize: "25px" }} />
                  <span>艺眼</span>
                </li>
                <li onClick={this.goto.bind(this, 'mine')} className={(this.props.currentTab === 'mine') ? "selected" : null}>
